...
#
# generate_vivado_project_for_noc_config_filereg_access_testbench.tcl: 
#   Tcl script for re-creating project 'noc_config_filereg_access_testbench'
#
...
#
#    SIM ENVIRONMENT:
#    "<repo_dir>/vivado/2022.2/noc_config_filereg_access/ip/axi4stream_vip_s/axi4stream_vip_s.xci"
#    "<repo_dir>/vivado/2022.2/noc_config_filereg_access/ip/axi4stream_vip_m/axi4stream_vip_m.xci"
#    "<repo_dir>/sim/noc_config_filereg_access_agent/noc_config_filereg_access_agent_pkg.sv"
#    "<repo_dir>/sim/noc_config_filereg_access/dv/env/noc_config_filereg_access_env_pkg.sv"
#    "<repo_dir>/sim/noc_config_filereg_access/dv/tests/noc_config_filereg_access_base_test.sv"
#    "<repo_dir>/sim/noc_config_filereg_access/dv/tb/axis_vip_tile.sv"
#    "<repo_dir>/sim/noc_config_filereg_access/dv/tb/duv.sv"
#    "<repo_dir>/sim/noc_config_filereg_access/dv/tb/tb.sv"
#
#*****************************************************************************************
...
set _xil_proj_name_ "noc_config_filereg_access_testbench"
...
set script_file "generate_vivado_project_for_noc_config_filereg_access_testbench.tcl"
...
set source_files_to_add [list \
 ...
 [file normalize "${repo_dir}/sim/noc_config_filereg_access/dv/tb/axis_vip_tile.sv"]\
 [file normalize "${repo_dir}/sim/noc_config_filereg_access/dv/tb/duv.sv"]\
]

set sim_files_to_import [list \
 [file normalize "${repo_dir}/vivado/2022.2/noc_config_filereg_access/ip/axi4stream_vip_s/axi4stream_vip_s.xci" ]\
 [file normalize "${repo_dir}/vivado/2022.2/noc_config_filereg_access/ip/axi4stream_vip_m/axi4stream_vip_m.xci" ]\
]

set sim_files_to_add [list \
 [file normalize "${repo_dir}/sim/noc_config_filereg_access_agent/filereg_if.sv"]\
 [file normalize "${repo_dir}/sim/noc_config_filereg_access_agent/noc_config_filereg_access_agent_pkg.sv"]\
 [file normalize "${repo_dir}/sim/noc_config_filereg_access/dv/env/noc_config_filereg_access_env_pkg.sv"] \
 [file normalize "${repo_dir}/sim/noc_config_filereg_access/dv/tests/noc_config_filereg_access_base_test.sv"] \
 [file normalize "${repo_dir}/sim/noc_config_filereg_access/dv/tb/tb.sv"] \
]
...
set_property -name "include_dirs" -value "[file normalize "$repo_dir/rtl/router-vc"] [file normalize "${repo_dir}/sim/noc_config_filereg_access/dv/tb"] [file normalize "${repo_dir}/vivado/2022.2/noc_config_filereg_access/sim"]" -objects $obj
...
set file "$repo_dir/sim/noc_config_filereg_access/dv/tb/duv.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$repo_dir/sim/noc_config_filereg_access/dv/tb/axis_vip_tile.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set file "$repo_dir/sim/noc_config_filereg_access/dv/tb/tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$repo_dir/sim/noc_config_filereg_access/dv/tests/noc_config_filereg_access_base_test.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$repo_dir/sim/noc_config_filereg_access/dv/env/noc_config_filereg_access_env_pkg.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$repo_dir/sim/noc_config_filereg_access_agent/noc_config_filereg_access_agent_pkg.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set_property -name "include_dirs" -value "[file normalize "/opt/Xilinx/Vivado/2022.2/data/xilinx_vip/include"] \
                                          [file normalize "$repo_dir/sim/noc_config_filereg_access_agent"] \
                                          [file normalize "$repo_dir/sim/noc_config_filereg_access/dv/tb"] \
                                          [file normalize "$repo_dir/sim/noc_config_filereg_access/dv/env"] \
                                          [file normalize "$repo_dir/rtl/router-vc"] \
                                          [file normalize "${repo_dir}/vivado/2022.2/noc_config_filereg_access/sim"]" -objects $obj
